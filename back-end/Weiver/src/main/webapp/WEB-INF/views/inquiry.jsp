...
<body>
    ...
    <header>
        ...
        <div class="title">
            <div class="back">
                <a href="http://3.36.252.181:8081/mypage/setting"><i class="bi bi-chevron-left" style="color: #EFEFEF"></i></a>
            </div>
    ...
    <div class="page">
        ...
        <!-- 글 작성 -->
        <div class="write">
            <button onclick="location.href='http://3.36.252.181:8081/inquiry/inquiryForm'">작성하기</button>
        </div>
        ...
        <div class="inquiry_board">
            <c:forEach var="inquiry" items="${inquiryList}">
                <div class="list">
                    <div class="inquiry">
                        <a href="http://3.36.252.181:8081/inquiryDetail/${inquiry.id}">
