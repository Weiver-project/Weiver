...
public interface SubscribeRepository extends JpaRepository<Subscribe, Long>{
	 ...
	 */
	@Query("SELECT s.musicalId, s.musicalId.title FROM Subscribe s WHERE s.type = ?1 GROUP BY s.musicalId ORDER BY COUNT(s) DESC")
	List<Object[]> findTop3MusicalIdsByDesiredType(String type);
